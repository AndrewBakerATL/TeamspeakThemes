...
<table class="info">
  ...
  <tr> <td>Connections: <span class="alternate">%%CLIENT_TOTALCONNECTIONS%%</span></td> </tr>
  ...
  <tr> <td>Volume Modifier: <span class="alternate"> %%?CLIENT_VOLUME_MODIFIER%% dB</span></td> </tr>
</table> 
